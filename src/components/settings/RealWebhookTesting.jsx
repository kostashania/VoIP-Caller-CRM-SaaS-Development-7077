...
function RealWebhookTesting() {
  ...
  -d '{"caller_id": "+306912345678","timestamp": "${new Date().toISOString()}","call_type": "incoming","webhook_id": "curl-test-${Date.now()}"}'`;
...
{`{"caller_id": "+306912345678","timestamp": "2024-01-01T12:00:00Z","call_type": "incoming","webhook_id": "unique-call-id"}`}
                  </pre>
                </div>
                <div>
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              ...
              <div className="mt-3 p-2 bg-yellow-100 rounded">
                <p className="text-xs">
                  <strong>✅ Production Ready!</strong> Your webhook endpoint is live at: <br />
                  <code className="text-blue-600 font-mono">{getProductionWebhookUrl(getUserCompanyId())}</code>
                </p>
              </div>
            </div>
